...
class AI21CompletionLLMEngine(LLMEngine):
    ...
    @retry(no_retry_on=(BadRequest, Unauthorized, UnprocessableEntity, MissingInputException, UnsupportedInputException,
                        UnsupportedDestinationException, OnlyOneInputException, WrongInputTypeException,
                        EmptyMandatoryListException, MissingApiKeyException, NoSpecifiedRegionException))
    def call(
